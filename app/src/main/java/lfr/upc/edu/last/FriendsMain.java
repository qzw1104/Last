...
public class FriendsMain extends AppCompatActivity implements View.OnClickListener {
   ...
   // private SQLiteDatabase myDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        more_name=intent.getStringExtra("name");
    ...
    private void initView() {
        //mySQLiteOpenHelper = new DBOpenHelper(FriendsMain.this, "LIBRARY_DB.db", null, 1);
        //myDatabase = mySQLiteOpenHelper.getReadableDatabase();
        button1 = (Button) findViewById(R.id.fanhui);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                System.out.println("我的列表被点击了");
                Intent mIntent = new Intent();
                mIntent.setClass(FriendsMain.this, Main2Activity.class);
...
//        checkAdd.setOnClickListener((View.OnClickListener) this);       //确认添加日程
    ...
    private void queryByDate(String date) {
        ...
        scheduleDetail=Database.getInstance().select_list("select scheduleDetail from "+jia+""+more_name+"");
        ArrayList<String> datetime=new ArrayList<String>();
        datetime=Database.getInstance().select_list("select datetime from "+jia+""+more_name+"");
...
//        Cursor cursor2 = myDatabase.query("'"+jia+""+more_name+"'", new String[]{"datetime"}, "time=?", new String[]{date}, null, null, null);
 ...
 //           do {
                ...
                mySchedule[scheduleCount].setText("日程" + (scheduleCount + 1) + "：" + "事件"+"  "+aScheduleDetail2);
...
//    }
    ...
    public void onClick(View v) {       //点击按钮监听
        ...
        intent1.setClass(FriendsMain.this, Main2Activity.class);//this前面为当前activty名称，class前面为要跳转到得activity名称
